    ...
    <div className="lg:mx-[120px] lg:pb-40 px-4 lg:px-0">
      ...
      <div className="w-full lg:flex  bg-base-100  mt-16   rounded-xl">
        <div className="w-full lg:w-[40%] lg:h-[480px] ">
          <div className="custom-background w-full h-full rounded-md text-white">
            <div className=" p-5">
          ...
          <div className="lg:px-20 my-10 px-5">
            <form>
              ...
              <div className=" flex justify-end pb-3">
                <button
                  type="submit"
                  className="lg:w-[60%] w-full  mt-5    py-2   rounded-3xl font-medium primary-bg-color text-lg uppercase text-white hover:bg-[#051c34] "
                >
                  Submit
                </button>
              </div>
